...
t.IGruppoPrest=S
var A=function(){function t(){}return t.sID="id",t.sID_FAR="idFar",t.sCODCSF="codCsf",t.sCODICE="codice",t.sDESCRIZIONE="descrizione",t.sDURATA="durata",t.sTIPO_PREZZO="tipoPrezzo",t.sPREN_ONLINE="prenOnLine",t.sFLAG_POSA="flagPosa",t.sPREZZO_LISTINO="prezzoListino",t.sSCONTO_ASS="scontoAss",t.sSCONTO_PERC="scontoPerc",t.sPREZZO_FINALE="prezzoFinale",t.sAVVERTENZE="avvertenze",t.sINDICAZIONI="indicazioni",t.sGRUPPO="gruppo",t.sDESC_GRUPPO="descGruppo",t.sTIPO="tipo",t.sDESC_TIPO="descTipo",t.sATTREZZATURE="attrezzature",t.sCOLLABORATORI="collaboratori",t.sPUNTI_COLL="puntiColl",t}()
t.IPrestazione=A
var g=function(){function t(){}return t.sDATA="data",t.sID_FAR="id_far",t.sID_COLLABORATORE="id_collaboratore",t.sRIGENERA="rigenera",t.sAGGIORNA="aggiorna",t.sNO_APPUNTAMENTI="no_appts",t.sRISORSE="resources",t.sSLOTS="slots",t.sAPPUNTAMENTI="appts",t.sORARI="times",t.sCHECK_USER_DESK="ckUserDesk",t}()
t.ICalendario=g
...
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),jrpc.execute("ATTREZZATURE.find",[t.AppUtil.putUserInfo(i.fpFilter.getState())],function(n){if(i.tabResult.setState(n),i.fpDetail.clear(),i.tabSel.setState([]),i.tabAll.clearSelection(),i.tabAll.clearFilter(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(n,t.IAttrezzatura.sID,i.selId)
...
o[t.IAttrezzatura.sID_FAR]=s,o[t.IAttrezzatura.sPRESTAZIONI]=i.tabSel.getState(),i.isNew?jrpc.execute("ATTREZZATURE.insert",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.btnDx.enabled=!1,i.btnSx.enabled=!1,i.btnPa.enabled=!1,i.selId=e[t.IAttrezzatura.sID],i.btnFind.trigger("click")}):jrpc.execute("ATTREZZATURE.update",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.btnDx.enabled=!1,i.btnSx.enabled=!1,i.btnPa.enabled=!1,i.selId=e[t.IAttrezzatura.sID]
...
if(a)return void WUX.showWarning("Specificare i seguenti campi: "+a)
var s=WUX.getComponent("boxFilter")
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),jrpc.execute("CHIUSURE.find",[t.AppUtil.putUserInfo(i.fpFilter.getState())],function(n){if(i.tabResult.setState(n),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(n,t.IChiusura.sID,i.selId)
a>=0&&setTimeout(function(){i.tabResult.select([a])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
...
if(!s)return void WUX.showWarning("Selezionare la struttura di competenza")
var o=i.fpDetail.getState()
o[t.IChiusura.sID_FAR]=s,i.isNew?jrpc.execute("CHIUSURE.insert",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IChiusura.sID],i.btnFind.trigger("click")}):jrpc.execute("CHIUSURE.update",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IChiusura.sID]
var n=i.tabResult.getSelectedRows()
if(n&&n.length){var a=n[0]
i.tabResult.getState()[a]=e,i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([a])},100)}else i.btnFind.trigger("click")})}),this.btnCancel=new WUX.WButton(this.subId("bc"),t.TXT.CANCEL,t.ICO.CANCEL,WUX.BTN.ACT_OUTLINE_INFO),this.btnCancel.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return void i.btnCancel.blur()
...
i.isNew?jrpc.execute("CLIENTI.insert",[t.AppUtil.putUserInfo(s)],function(n){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=n[t.ICliente.sID],i.fpFilter.isBlank(t.ICliente.sCOGNOME)&&i.fpFilter.setValue(t.ICliente.sCOGNOME,e.getString(n,t.ICliente.sCOGNOME)),i.btnFind.trigger("click")}):jrpc.execute("CLIENTI.update",[t.AppUtil.putUserInfo(s)],function(n){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=n[t.ICliente.sID]
...
t.CFSelectClienti=S
var A=function(t){function e(e,i,n,a){var s=t.call(this,e||"*","CFSelectColore",null,i,n,a)||this
...
t.CFSelectColore=A
var g=function(i){function n(t,e,n,a){var s=i.call(this,t||"*","CFOrariSett",null,e,n,a)||this
...
if(a)return void WUX.showWarning("Specificare i seguenti campi: "+a)
var s=WUX.getComponent("boxFilter")
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),jrpc.execute("COMUNICAZIONI.find",[t.AppUtil.putUserInfo(i.fpFilter.getState())],function(n){if(i.tabResult.setState(n),i.fpDetail.clear(),i.tabList.setState([]),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(n,t.IComunicazione.sID,i.selId)
a>=0&&setTimeout(function(){i.tabResult.select([a])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
...
return r&&r.length?r.length>160?void WUX.showWarning("Il messaggio ha "+r.length+" caratteri (massimo consentito 160)."):(o[t.IComunicazione.sID_FAR]=s,void(i.isNew?jrpc.execute("COMUNICAZIONI.insert",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IComunicazione.sID],i.btnFind.trigger("click")}):jrpc.execute("COMUNICAZIONI.update",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IComunicazione.sID]
var n=i.tabResult.getSelectedRows()
if(n&&n.length){var a=n[0]
...
t.DlgCambioPrest=S
var A=function(i){function n(n){var a=i.call(this,n,"DlgOrgPrest")||this
...
t.DlgOrgPrest=A
var g=function(i){function n(n){var a=i.call(this,n,"DlgNuovoApp")||this
...
e&&(a.tabClienti.setState([e]),a.lblNote.setState(""),setTimeout(function(){a.tabClienti.select([0])},100))}}),a.dlgOrgPres=new A(a.subId("dlp")),a.dlgOrgPres.onHiddenModal(function(t){a.dlgCliente.cancel||(a.prestSort=a.dlgOrgPres.getState())}),a.btnNew=new WUX.WButton(a.subId("bba"),"",t.ICO.ADD,WUX.BTN.PRIMARY,{p:"1px 6px 0px 6px"}),a.btnNew.tooltip="Registra nuovo cliente",a.btnNew.on("click",function(t){a.dlgCliente.setState(null),a.dlgCliente.show(a)}),a.txtSearch=new WUX.WInput("txtTest",WUX.WInputType.Text),a.txtSearch.css({w:"84%"}),a.txtSearch.tooltip="Ricerca cliente",a.txtSearch.placeHolder="Ricerca cliente",a.txtSearch.onEnterPressed(function(e){var i=a.txtSearch.getState()
...
case"N":WUX.setCss(i.rowElement,WUX.CSS.ERROR)
break
case"A":WUX.setCss(i.rowElement,WUX.CSS.COMPLETED)}}}),this.cntActions=new t.AppTableActions("ta"),this.container=new WUX.WContainer,this.container.attributes=WUX.ATT.STICKY_CONTAINER,this.container.addBox("Filtri di ricerca:","","","boxFilter",WUX.ATT.BOX_FILTER).addTool(this.tagsFilter).addCollapse(this.collapseHandler.bind(this)).addRow().addCol("col-xs-11 b-r").add(this.fpFilter).addCol("col-xs-1 b-l").addGroup({classStyle:"form-group text-right"},this.btnFind,this.btnReset).end().addBox().addGroup({classStyle:"search-actions-and-results-wrapper"},this.cntActions,this.tabResult).end().addRow().addCol("12").add(this.lblResult),this.container},n.prototype.collapseHandler=function(t){e.getBoolean(t.data,"collapsed")?this.tagsFilter.setState({}):this.tagsFilter.setState(this.fpFilter.getValues(!0))},n.prototype.componentDidMount=function(){var i=this,n=0
...
h+="<tr>"
for(var r=0;r<this.resources.length;r++){var l=this.resources[r],A=this.COLOR_NA,g=this.slots[l.id+"_"+S]
switch(g||(g=0),g){case 1:A=this.COLOR_AV
break
case 2:A=this.COLOR_BK
break
case-2:A=this.COLOR_BK_OL
break
case 3:A=this.COLOR_EX
break
case-3:A=this.COLOR_EX_OL
break
case 4:A=this.COLOR_NE
break
case-4:A=this.COLOR_NE_OL
break
case 5:A=this.COLOR_SU
break
case-5:A=this.COLOR_SU_OL}var T=this.appts[l.id+"_"+S]
if(T){T.id&&g<0&&this._lstolb.push(T.id)
var C=T.descCliente
C&&C.length>5&&(C=C.substring(0,5))
var D=T.descPrest
D&&D.length>5&&(D=D.substring(0,5)),C||(C="&nbsp;"),D||(D="&nbsp;")
var U="<br>"+C+"<br>"+D,W=""
"F"==T.tipo?W="background-image:url(/bookme/img/heart.png);background-repeat:no-repeat;":"O"==T.tipo&&(W="background-image:url(/bookme/img/star.png);background-repeat:no-repeat;"),h+='<td style="border:1px solid #b5b5b5;"><div style="line-height:13px;font-size:14px;width:100%;text-align:center;overflow:hidden;background-color:'+A+";color:"+this.COLOR_AP+";font-weight:bold;"+W+'"><span id="a'+T.id+'">'+b+":"+f+U+"</span></div></td>"}else if("00"==f){var P=g<2?b+":"+f:"",U="<br>&nbsp;<br>&nbsp;"
h+='<td style="border:1px solid #b5b5b5;"><div style="line-height:13px;font-size:14px;width:100%;text-align:center;overflow:hidden;background-color:'+A+";color:"+this.COLOR_HH+';font-weight:bold;">'+P+U+"</div></td>"}else{var P=g<2?b+":"+f:"",U="<br>&nbsp;<br>&nbsp;"
h+='<td style="border:1px solid #b5b5b5;"><div style="line-height:13px;font-size:14px;width:100%;text-align:center;overflow:hidden;background-color:'+A+";color:"+this.COLOR_MM+';">'+P+U+"</div></td>"}}h+="</tr>"}h+="</tbody>",h+="</table>",this.$body.append(h)
...
a&&(n[t.IPrenotazione.sDATA_APP]=WUX.formatDate(a,!0))
var o=e.getDate(n,t.IPrenotazione.sDATA_PREN)
o&&(n[t.IPrenotazione.sDATA_PREN]=WUX.formatDateTime(o,!1,!0)),i.dlgPren.setState(n),i.dlgPren.show()})}}),this.cntActions=new t.AppTableActions("ta"),this.container=new WUX.WContainer,this.container.attributes=WUX.ATT.STICKY_CONTAINER,this.container.addBox("Filtri di ricerca:","","","boxFilter",WUX.ATT.BOX_FILTER).addTool(this.tagsFilter).addCollapse(this.collapseHandler.bind(this)).addRow().addCol("col-xs-11 b-r").add(this.fpFilter).addCol("col-xs-1 b-l").addGroup({classStyle:"form-group text-right"},this.btnFind,this.btnReset).end().addBox().addGroup({classStyle:"search-actions-and-results-wrapper"},this.cntActions,this.tabResult).end().addRow().addCol("12").add(this.lblResult),this.container},n.prototype.collapseHandler=function(t){e.getBoolean(t.data,"collapsed")?this.tagsFilter.setState({}):this.tagsFilter.setState(this.fpFilter.getValues(!0))},n.prototype.componentDidMount=function(){var i=this,n=0
t.strutture&&t.strutture.length&&(n=t.strutture[0].id)
var a=e.toDate(e.getParam("d"))
if(!a)return void(n&&this.selFar.setState(n))
var s=e.toNumber(e.getParam("f"))
...
if(a)return void WUX.showWarning("Specificare i seguenti campi: "+a)
var s=WUX.getComponent("boxFilter")
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),jrpc.execute("GRUPPI_PREST.find",[t.AppUtil.putUserInfo(i.fpFilter.getState())],function(n){if(i.tabResult.setState(n),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(n,t.IPrestazione.sID,i.selId)
a>=0&&setTimeout(function(){i.tabResult.select([a])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
...
if(a)return void WUX.showWarning("Specificare i seguenti campi: "+a)
var s=WUX.getComponent("boxFilter")
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),jrpc.execute("PRESTAZIONI.find",[t.AppUtil.putUserInfo(i.fpFilter.getState())],function(n){if(i.tabResult.setState(n),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(n,t.IPrestazione.sID,i.selId)
a>=0&&setTimeout(function(){i.tabResult.select([a])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
...
if(a)return void WUX.showWarning("Specificare i seguenti campi: "+a)
var s=WUX.getComponent("boxFilter")
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),jrpc.execute("UTENTI_DESK.find",[t.AppUtil.putUserInfo(i.fpFilter.getState())],function(n){if(i.tabResult.setState(n),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(n,t.IUtenteDesk.sID,i.selId)
a>=0&&setTimeout(function(){i.tabResult.select([a])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
...
i.isNew?jrpc.execute("UTENTI_DESK.insert",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IUtenteDesk.sID],i.btnFind.trigger("click")}):jrpc.execute("UTENTI_DESK.update",[t.AppUtil.putUserInfo(o)],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IUtenteDesk.sID]
var n=i.tabResult.getSelectedRows()
if(n&&n.length){var a=n[0]
i.tabResult.getState()[a]=e,i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([a])},100)}else i.btnFind.trigger("click")})}),this.btnCancel=new WUX.WButton(this.subId("bc"),t.TXT.CANCEL,t.ICO.CANCEL,WUX.BTN.ACT_OUTLINE_INFO),this.btnCancel.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return void i.btnCancel.blur()
WUX.confirm(t.MSG.CONF_CANCEL,function(t){t&&(i.isNew?i.fpDetail.clear():i.onSelect(),i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=null)})}),this.btnDelete=new WUX.WButton(this.subId("bd"),t.TXT.DELETE,t.ICO.DELETE,WUX.BTN.ACT_OUTLINE_DANGER),this.btnDelete.on("click",function(n){if(i.selId=null,i.btnDelete.blur(),i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void WUX.showWarning("Elemento in fase di modifica.")
